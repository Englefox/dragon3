...
namespace Cell
{
    ...
    */
    ...
    public:
        ...
        void RemoveChild(unsigned int id); // TODO: think of proper way to unqiuely idetnfiy child nodes (w/ incrementing node ID or stringed hash ID?)
