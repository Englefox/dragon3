#ifndef UTILITY_FLOATINGT_POINT_H
#define UTILITY_FLOATINGT_POINT_H
...
namespace floating_point
{
	...
	*/
	inline bool compare(const float a, const float b, const float epsilon)
	{
		...
		// NOTE: originally we want to take the absolute max of either
	...
	// NOTE: the above comparrison is more general, but can still be too
