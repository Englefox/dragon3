...
namespace Cell
{
    PBR::PBR(Renderer* renderer)
    {
        ...
        Cell::Shader *hdrToCubemap      = Cell::Resources::LoadShader("pbr:hdr_to_cubemap", "D:/engle/dragon3/dragon3/build/shaders/pbr/cube_sample.vs", "D:/engle/dragon3/dragon3/build/shaders/pbr/spherical_to_cube.fs");
        Cell::Shader *irradianceCapture = Cell::Resources::LoadShader("pbr:irradiance", "D:/engle/dragon3/dragon3/build/shaders/pbr/cube_sample.vs", "D:/engle/dragon3/dragon3/build/shaders/pbr/irradiance_capture.fs");
        Cell::Shader *prefilterCapture  = Cell::Resources::LoadShader("pbr:prefilter", "D:/engle/dragon3/dragon3/build/shaders/pbr/cube_sample.vs", "D:/engle/dragon3/dragon3/build/shaders/pbr/prefilter_capture.fs");
        Cell::Shader *integrateBrdf     = Cell::Resources::LoadShader("pbr:integrate_brdf", "D:/engle/dragon3/dragon3/build/shaders/screen_quad.vs", "D:/engle/dragon3/dragon3/build/shaders/pbr/integrate_brdf.fs");
        ...
        // capture
        m_ProbeCaptureShader = Resources::LoadShader("pbr:capture", "D:/engle/dragon3/dragon3/build/shaders/capture.vs", "D:/engle/dragon3/dragon3/build/shaders/capture.fs");
        ...
        m_ProbeCaptureBackgroundShader = Resources::LoadShader("pbr:capture background", "D:/engle/dragon3/dragon3/build/shaders/capture_background.vs", "D:/engle/dragon3/dragon3/build/shaders/capture_background.fs");
        m_ProbeCaptureBackgroundShader->Use();
        m_ProbeCaptureBackgroundShader->SetInt("background", 0);

        // debug render
        m_ProbeDebugSphere = new Sphere(32, 32);
        m_ProbeDebugShader = Cell::Resources::LoadShader("pbr:probe_render", "D:/engle/dragon3/dragon3/build/shaders/pbr/probe_render.vs", "D:/engle/dragon3/dragon3/build/shaders/pbr/probe_render.fs");
