...
namespace Cell
{
    ...
    void CommandBuffer::Push(Mesh* mesh, Material* material, AnimatedMeshLoader* amesh, math::mat4 transform, math::mat4 prevTransform, math::vec3 boxMin, math::vec3 boxMax, RenderTarget* target)
    {
