...
namespace Cell
{
    ...
    */
    ...
    public:
        ...
        void Push(Mesh* mesh, Material* material, AnimatedMeshLoader* amesh, math::mat4 transform = math::mat4(), math::mat4 prevTransform = math::mat4(), math::vec3 boxMin = math::vec3(-99999.0f), math::vec3 boxMax = math::vec3(99999.0f), RenderTarget* target = nullptr);
