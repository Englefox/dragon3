...
Cell::FlyCamera camera(math::vec3(0.0f, 0.2f, 0.5f), math::vec3(0.0f, 0.0f, -1.0f));
...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    //Cell::Shader*   plasmaOrbShader = Cell::Resources::LoadShader("plasma orb", "D:/engle/dragon3/dragon3/build/shaders/custom/plasma_orb.vs", "D:/engle/dragon3/dragon3/build/shaders/custom/plasma_orb.fs");
   ...
   // matPlasmaOrb->BlendDst = GL_ONE;
    //matPlasmaOrb->SetTexture("TexPerllin", Cell::Resources::LoadTexture("perlin noise", "D:/engle/dragon3/dragon3/build/textures/perlin.png"), 0);    
   ...
   // thirdTorus->SetScale(0.65f);
    ...
    // post processing
    Cell::Shader *postProcessing1 = Cell::Resources::LoadShader("post_processing1", "D:/engle/dragon3/dragon3/build/shaders/screen_quad.vs", "D:/engle/dragon3/dragon3/build/shaders/custom_post_1.fs");
    Cell::Shader *postProcessing2 = Cell::Resources::LoadShader("post_processing2", "D:/engle/dragon3/dragon3/build/shaders/screen_quad.vs", "D:/engle/dragon3/dragon3/build/shaders/custom_post_2.fs");
    ...
    // mesh 
    Cell::SceneNode* sponza = Cell::Resources::LoadMesh(renderer, "sponza", "D:/engle/dragon3/dragon3/build/meshes/LakeCity/LakeCity.obj");
    sponza->SetPosition(math::vec3(0.0, -1.0, 0.0));
    sponza->SetScale(0.01f);

	Cell::SceneNode* aircraft = Cell::Resources::LoadMesh(renderer, "aircraft", "D:/engle/dragon3/dragon3/build/meshes/aircraft/Aircraft.obj");
	aircraft->SetPosition(math::vec3(0.0, 0.5, 0.0));
	aircraft->SetScale(0.1f);

	Cell::AnimatedMeshLoader* m_mesh = nullptr;
	Cell::Resources* R = new Cell::Resources();
	Cell::SceneNode* man = R->LoadAnimatedMesh(renderer, "man", "D:/engle/dragon3/dragon3/build/meshes/man/bob_lamp_update.md5mesh", m_mesh);
	man->AMesh = m_mesh;
	man->SetPosition(math::vec3(0.0, 0.1, -0.5));
	man->SetScale(0.01f);
    ...
    while (!glfwWindowShouldClose(window))
    {
...

        {
			...
			aircraft->SetRotation(math::vec4(math::vec3(1.0f, -1.0f, 0.0f), glfwGetTime() * 3.0));
...

        {
           ...
           // renderer->PushRender(mainTorus);
			...
			renderer->PushRender(aircraft);
			renderer->PushRender(man);
