...
namespace Cell
{
    PostProcessor::PostProcessor(Renderer* renderer)
    {
        ...
        {
            m_PostProcessShader = Cell::Resources::LoadShader("post process", "D:/engle/dragon3/dragon3/build/shaders/screen_quad.vs", "D:/engle/dragon3/dragon3/build/shaders/post_processing.fs");
        ...
        // down sample
        {
            ...
            m_DownSampleShader = Cell::Resources::LoadShader("down sample", "D:/engle/dragon3/dragon3/build/shaders/screen_quad.vs", "D:/engle/dragon3/dragon3/build/shaders/post/down_sample.fs");
        ...
        // gaussian blur shader
        {
            ...
            m_OnePassGaussianShader = Cell::Resources::LoadShader("gaussian blur", "D:/engle/dragon3/dragon3/build/shaders/screen_quad.vs", "D:/engle/dragon3/dragon3/build/shaders/post/blur_guassian.fs");
        ...
        // ssao
        {
            ...
            m_SSAOShader = Cell::Resources::LoadShader("ssao", "D:/engle/dragon3/dragon3/build/shaders/screen_quad.vs", "D:/engle/dragon3/dragon3/build/shaders/post/ssao.fs");
            m_SSAOShader->Use();
        ...
        // bloom 
        {
            ...
            m_BloomShader = Cell::Resources::LoadShader("bloom", "D:/engle/dragon3/dragon3/build/shaders/screen_quad.vs", "D:/engle/dragon3/dragon3/build/shaders/post/bloom.fs");
            m_SSAOShader->Use();
