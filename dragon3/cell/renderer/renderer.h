...
#include "gl_cache.h"
#include "../glad/glad.h"
#include "../resources/animated_mesh_loader.h"
namespace Cell
{
    /* 
    ...
    */
    ...
    public:
        ...
        void PushRender(Mesh* mesh, Material* material, AnimatedMeshLoader* amesh, math::mat4 transform = math::mat4(), math::mat4 prevFrameTransform = math::mat4());
    ...
    private:
		...
		void renderAMesh(Mesh* mesh, Shader* shader, AnimatedMeshLoader* m_mesh);
