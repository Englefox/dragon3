...
namespace math
{
    ...
    */
    struct quaternion
    {
        ...
        //construct a zero quaternion rotation
        ...
        //convert from axis-angle format (in radians) to quaternion
        ...
        //convert from axis-angle format (with w being 0.0f)
    ...
    // rotates a vector p by quaternion q. 
    ...
    //the quaternion is assumed to be normalized (length of 1)
    ...
    // as there are a lot of duplicated terms there is a more 
